...
const routes: Routes = [
  ...
  { path: 'artigos/artigo/:id', component: ArtigoComponent},
  { path: 'atividades', component: AtividadesComponent},
  { path: 'atividades/atividade/:id', component: AtividadeComponent},
  ...
  { path: 'adm/atividades/criar', component: AtividadesCriarComponent},
  { path: 'adm/atividades/modificar/:id', component: AtividadesModificarComponent},
  { path: 'adm/atividades/excluir/:id', component: AtividadesExcluirComponent},
  { path: 'adm/artigos', component: ArtigosCrudComponent},
  { path: 'adm/artigos/criar', component: ArtigosCriarComponent},
  { path: 'adm/artigos/modificar/:id', component: ArtigosModificarComponent},
  { path: 'adm/artigos/excluir/:id', component: ArtigosExcluirComponent},
  { path: 'adm/usuarios', component: UsuariosCrudComponent},
  { path: 'adm/usuarios/excluir', component: UsuariosExcluirComponent},
  { path: 'adm/categorias', component: CategoriasCrudComponent},
  { path: 'adm/categorias/criar', component: CategoriasCriarComponent},
  { path: 'adm/categorias/modificar/:id', component: CategoriasModificarComponent},
  { path: 'adm/categorias/excluir/:id', component: CategoriasExcluirComponent },
